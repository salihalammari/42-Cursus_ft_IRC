...
/*   Updated: 2023/02/20 13:37:22 by slammari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define RPL_WHOISUSER(source, user, hostname, real_name)   "311 " + source + " " + user + " " + hostname + " * :"+ real_name
# define RPL_WHOISSERVER(source, name)                      "312 " + name + " " + source + " : " 
# define RPL_ENDOFWHOIS(nick_name)                          "318 " + nick_name + " :End of /WHOIS list"
# define RPL_ENDOFWHOWAS(nick_name)                         "369 " + nick_name + " :End of WHOWAS"
